...
淋巴细胞绝对值 = st.number_input("淋巴细胞绝对值 (10^9/L)", value=50.0, help="单位: 10^9/L")
...
平均红细胞体积 = st.number_input("平均红细胞体积 (fL)", value=90.0, help="单位: fL")
肌酐 = st.number_input("肌酐 (μmol/L)", value=50.0, help="单位: μmol/L")
平均红细胞血红蛋白浓度 = st.number_input("平均红细胞血红蛋白浓度 (g/dL)", value=30.0, help="单位: g/dL")
总胆红素 = st.number_input("总胆红素 (μmol/L)", value=10.0, help="单位: μmol/L")
